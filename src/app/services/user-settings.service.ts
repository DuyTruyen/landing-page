...
export class UserSettingsService extends BaseService {
  ...
  updateFilterAndSort(payload: any): Observable<any>{
      return this.put(`${this.url}/FilterAndSort`, payload);
  }
  resetFilterAndSort(): Observable<any>{
      return this.get(`${this.url}/ResetFilterAndSort`);
  }
}
