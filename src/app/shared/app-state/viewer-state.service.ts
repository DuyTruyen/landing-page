...
export class ViewerStateService {
  ...
  protected isShowPasmearViewerSubject: BehaviorSubject<boolean>;

  protected isShowPasmearViewer:boolean = false;
  ...
  constructor()
  {
    ...
    this.isShowPasmearViewerSubject = new BehaviorSubject<boolean>(this.isShowPasmearViewer);
  }
  ...
  public subscribeIsShowPasmearViewer(callback: (data: any) => void): Subscription {
    return this.isShowPasmearViewerSubject.subscribe(callback);
  }
  public dispatchIsShowPasmearViewer(value:boolean): void {
    this.isShowPasmearViewer = value
    this.isShowPasmearViewerSubject.next(this.isShowPasmearViewer);
  }
  ...
  public closeTab(id: string) {
    ...
    if (this.currentCase.caseStudyId == id) {
