...
ngOnInit(): void {
    this.cols = [
        { field: 'name', header: 'Tên chuyên khoa', isOpSort: true, iconSort : 0, width: '20rem' },
        { field: 'description', header: 'Mô tả', isOpSort: true, iconSort : 0, width: '50rem' },
        { field: 'status', header: 'Trạng thái',  width: '5rem' }
      ];
      this.getAll();
}
